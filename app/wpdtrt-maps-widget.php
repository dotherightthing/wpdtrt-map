...
if ( !class_exists( 'Wpdtrt_Maps_Widget' ) ) {
   ...
   */
  class Wpdtrt_Maps_Widget extends WP_Widget {

    function __construct() {
      // Instantiate the parent object
      parent::__construct( false, 'DTRT Maps Widget' );
    }
     ...
     * This function's variables will be available to this template.
     */
      require(WPDTRT_MAPS_PATH . 'templates/wpdtrt-maps-widget.php');
    }
  }

}

if ( !function_exists( 'wpdtrt_maps_register_widgets' ) ) {
  ...
  function wpdtrt_maps_register_widgets() {
    register_widget( 'Wpdtrt_Maps_Widget' );
  }

  add_action( 'widgets_init', 'wpdtrt_maps_register_widgets' );
